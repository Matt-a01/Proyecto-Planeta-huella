...
const AuthModal = ({ isOpen, onClose, onAuthSuccess }) => {
    ...
    // Si el modal principal no está abierto, no renderiza nada
    if (!isOpen) return null;

    // Actualiza los datos del formulario de manera dinámica
    const handleChange = (e) => setFormData({ ...formData, [e.target.name]: e.target.value });

    // --- LÓGICA DE ENVÍO (REGISTRO / LOGIN) ---
    const handleSubmit = async (e) => {
        e.preventDefault();
        setLoading(true);
        setErrorMsg('');

        // Validación de términos obligatoria para el registro
    ...
    return (
        ...
        {/* Contenedor principal de la ventana blanca */}
        <div className="bg-white rounded-3xl p-8 w-full max-w-md shadow-2xl relative max-h-[90vh] overflow-y-auto">
            ...
            {/* Campo de Contraseña con botón de mostrar/ocultar (Común) */}
            ...
            {/* Formulario condicional: Datos extra para mapa (Instituciones) */}
            ...
            {/* Sección de Checkbox y Botón de Enviar */}
            <div className="flex flex-col gap-3">
                ...
                <div className="bg-stone-50 p-3 rounded-xl border">
                    ...
                    <span className="text-sm text-stone-600">
                        ...
                        className="text-emerald-600 font-semibold hover:underline bg-transparent border-none p-0 cursor-pointer inline"
                        >
            ...
            {/* Botón inferior para alternar entre Login y Registro */}
        ...
        {/* MODAL DE TÉRMINOS Y CONDICIONES (Renderizado fuera de la caja blanca principal para flotar encima) */}
        <TermsModal 
